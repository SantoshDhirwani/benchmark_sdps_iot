...
pushd seep-system/examples/stateful-test ; ant clean ; popd
pushd seep-system/examples/stateful-window-query ; ant clean ; popd
...
mkdir -p seep-system/examples/stateful-test/lib
mkdir -p seep-system/examples/stateful-window-query/lib
mkdir -p seep-system/examples/debs_gc_2014/lib
...
cp seep-system/target/seep-system-0.0.1-SNAPSHOT.jar seep-system/examples/debs_gc_2014/lib
cp seep-system/target/seep-system-0.0.1-SNAPSHOT.jar seep-system/examples/stateless-simple-query/lib
cp seep-system/target/seep-system-0.0.1-SNAPSHOT.jar seep-system/examples/stateful-test/lib
cp seep-system/target/seep-system-0.0.1-SNAPSHOT.jar seep-system/examples/stateful-window-query/lib
...
pushd seep-system/examples/stateless-simple-query ; ant dist; popd
pushd seep-system/examples/stateful-window-query ; ant dist; popd
pushd seep-system/examples/stateful-test ; ant dist; popd
